    ...
    <div className="flex justify-center mt-10 ">
      <div className="bg-white w-2/3 max-w-150 min-h-150 rounded-lg shadow-lg px-10 py-5 animate-appear">
        ...
        <div className="flex w-max mx-auto mt-7">
          <button className="text-[15px] font-default flex hover:bg-indigo-800/30 hover:cursor-pointer transition duration-300 ease-smooth pt-2 pb-2 pr-5 pl-4 rounded-full hover:scale-110 bg-gray-200">
            <PlusIcon
